...
func ProductGetDB(Product_id int64) (product models.ProductModels, err error) {
	...
	if err != nil {
		if err == sql.ErrNoRows {
            return models.ProductModels{}, nil
        }
...
func ProductPOSTDB(product models.ProductModels) (err error) {
...
func ProductPUTDB(product models.ProductModels) (err error) {
